...
height=int(input("Give the height of the person in cm : "))
weight=int(input("Give the weight of the person in Kg : "))

weight=weight-72
height=height-166

person=np.array([weight, height])
result=network.feedforward(person)
